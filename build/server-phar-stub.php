...
/**
 * Prepares a decompressed .tar of SleepPro-0.3-PUBLIC.phar in the system temp directory for loading code from.
 *
...
echo "Preparing SleepPro-0.3-PUBLIC.phar decompressed cache...\n";
$start = hrtime(true);
