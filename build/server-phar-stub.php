...
/**
 * Prepares a decompressed .tar of SleepPro-0.2-Public.phar in the system temp directory for loading code from.
 *
...
echo "Preparing SleepPro-0.2-Public.phar decompressed cache...\n";
$start = hrtime(true);
