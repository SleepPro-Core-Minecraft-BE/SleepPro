...
$defaultConfig = yaml_parse(Filesystem::fileGetContents(dirname(__DIR__, 2) . '/resources/settings.yml'));

if(!is_array($defaultConfig)){
	fwrite(STDERR, "Invalid default settings.yml\n");
	exit(1);
}
...
/**
 * @internal
 * Constants for all properties available in settings.yml.
